...
#input_dir = '/home/jpeter/tmp_data/radar/rob/20111225/Gambier/rapic/'
#input_dir = '/home/jpeter/tmp_data/radar/rob/20111225/NE_Vic/rapic/'
#input_dir = '/data/Q0128/pub/jpeter/radar/rapic/2001/vol/'
input_dir = '/data/Q0128/pub/jpeter/radar/rapic/2002/vol/'
...
##fls = glob.iglob('input_dir/*.VOL')
##fls = ['radar.Cairns.20001218.VOL']
#fls = ['radar.Kurnell.20010311.VOL']
...
output_dir = '/data/Q0128/pub/jpeter/radar/rapic/2002/extract/'
...
#Try to search for the start and end indices
#start = [i for i,x in enumerate(lines) if re.match("""/IMAGE:""",x)]
#end = [i for i,x in enumerate(lines) if re.match("""/IMAGEEND:""",x)]
#stop=[x+1 for x in end]
#fout.writelines(islice(fin, start[i], stop[i], 1)) #Put in loop as above
